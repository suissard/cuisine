...
export interface ApiCategoriePlatCategoriePlat
  extends Struct.CollectionTypeSchema {
  collectionName: 'categorie_plats';
  info: {
    displayName: 'CategoriePlat';
    pluralName: 'categorie-plats';
    singularName: 'categorie-plat';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::categorie-plat.categorie-plat'
    > &
      Schema.Attribute.Private;
...
export interface ApiRecetteRecette extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    degustation: Schema.Attribute.Enumeration<
      ['Froid', 'Chaud', 'Ti\u00E8de', 'Ambiant']
    >;
    description: Schema.Attribute.Text;
    difficulte: Schema.Attribute.Component<'meta.difficulte', false>;
    etapes: Schema.Attribute.Component<'recette.etape', true>;
    image: Schema.Attribute.Media<'images'>;
    ingredients: Schema.Attribute.Component<'recette.recette-ingredient', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::recette.recette'
    > &
      Schema.Attribute.Private;
    materiel_global: Schema.Attribute.Relation<
      'manyToMany',
      'api::materiel.materiel'
    >;
    origine: Schema.Attribute.String;
    portions: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::categorie-plat.categorie-plat': ApiCategoriePlatCategoriePlat;
